...
//! 3. [`separate`] — push overlapping bodies apart. **After** walking, so it
//!    resolves where things actually are this tick rather than where they were.
//! 4. [`contain`] — put everything back inside the arena. **After** separating,
...
//! 5. [`face`] — turn the body toward its direction of travel. Last because
