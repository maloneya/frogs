...
impl ApplicationHandler for App {
    ...
    fn resumed(&mut self, event_loop: &ActiveEventLoop) {
        ...
        self.renderer = Some(pollster::block_on(Renderer::new(window, display_handle)));
    }
...
fn main() {
    ...
    // Poll rather than Wait: never block waiting for input, just keep looping.
    // Vsync in the surface config is what actually paces us, not this.
